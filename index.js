...
app.post("/submit", (req, res) => {
  var randomValueAdj = Math.floor(Math.random()*adj.length);
  var randomValueNoun = Math.floor(Math.random()*noun.length);
  let wordOne = adj[randomValueAdj]; 
  let wordTwo = noun[randomValueNoun];
  res.render("index.ejs", { fWord: wordOne, sWord: wordTwo });
...
// console.log(randomValueAdj);
// console.log(adj.length);
// console.log(randomValueNoun);
